...
public class NativeDesktop {
	...
	private static boolean checkProjectExists(String projectName) {
		String pathToProjectDirectory = Utils.buildProjectPath(projectName);
		File projectDirectory =  new File(pathToProjectDirectory);
		if(!projectDirectory.exists()) {
			return false;
		}
		
		File projectFile = new File(Utils.buildPath(pathToProjectDirectory, Consts.PROJECTCODE_NAME));
