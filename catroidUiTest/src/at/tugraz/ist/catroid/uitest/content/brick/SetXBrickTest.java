...
public class SetXBrickTest extends ActivityInstrumentationTestCase2<ScriptTabActivity> {
	...
	public void testChangeXByBrick() {
		...
		UiTestUtils.testBrickWithFormulaEditor(solo, R.id.brick_set_x_text_view, 9, SET_X, "xPosition", setXBrick);
