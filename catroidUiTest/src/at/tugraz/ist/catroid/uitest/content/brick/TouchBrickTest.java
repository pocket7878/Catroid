...
public class TouchBrickTest extends ActivityInstrumentationTestCase2<ScriptActivity> {
	private Solo solo;
	private Project project;

	public TouchBrickTest() {
	...
	@Smoke
	public void testTouchBrickTest() throws InterruptedException {
		...
		assertNotNull("TextView does not exist", solo.getText(getActivity().getString(R.string.brick_touch)));
		solo.clickOnView(solo.getCurrentActivity().findViewById(R.id.touch_spinner));
	...
	private void createProject() {
		...
		TouchBrick touchedBrick = new TouchBrick(sprite1, sprite2);
		startScript1.addBrick(touchedBrick);
