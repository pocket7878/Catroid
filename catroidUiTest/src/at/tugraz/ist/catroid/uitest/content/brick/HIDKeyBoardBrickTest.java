...
public class HIDKeyBoardBrickTest extends ActivityInstrumentationTestCase2<ScriptActivity> {
	private Solo solo;
	private Project project;
	private HIDKeyBoardButtonBrick keyBoardButtonBrick;

	public HIDKeyBoardBrickTest() {
	...
	@Smoke
	public void testKeyChooseBrick() {
		...
		for (int i = 1; i < array.length; i++) {
			...
			assertEquals("Wrong item in spinner!", array[i], solo.getCurrentSpinners().get(0).getSelectedItem());
		}
