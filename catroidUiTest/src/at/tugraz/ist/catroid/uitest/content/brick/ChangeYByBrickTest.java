...
public class ChangeYByBrickTest extends ActivityInstrumentationTestCase2<ScriptTabActivity> {
	...
	public void testChangeYByBrick() {
		...
		UiTestUtils.testBrickWithFormulaEditor(solo, R.id.brick_change_y_text_view, 9, Y_TO_CHANGE, "yMovement",
				changeYByBrick);
