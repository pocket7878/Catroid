 ...
 */
package at.tugraz.ist.catroid.uitest.drone.bricks;
...
public class DroneBrickSampleTest extends ActivityInstrumentationTestCase2<ScriptActivity> {
	private Solo solo;
	private Project project;
	private NXTMotorActionBrick motorBrick;
	private DroneChangeFlyingModeBrick changeFlyingModeBrick;
	...
	public void testSomething() {
		...
		int flyingMode = (Integer) UiTestUtils.getPrivateField("flyingMode", changeFlyingModeBrick);
		assertEquals("flying mode should be zero", flyingMode, 0);
	...
	private void createProject() {
		...
		changeFlyingModeBrick = new DroneChangeFlyingModeBrick(sprite, 0);
		setSpeed = 30;

		script.addBrick(changeFlyingModeBrick);
