 ...
 */
package at.tugraz.ist.catroid_youtube.transfers;
...
import at.tugraz.ist.catroid_youtube.utils.UtilDeviceInfo;
...
public class VideoUploadTask extends AsyncTask<Void, Void, Boolean> {
	...
	public VideoUploadTask(Context context, String projectName, String videoName, String videoDescription,
	...
	protected Boolean doInBackground(Void... arg0) {
		try {
			...
			ServerCalls.getInstance().uploadVideo(projectName, videoName, videoDescription, zipFileString, userEmail,
					language, token);
			zipFile.delete();
			return true;
		} catch (IOException e) {
