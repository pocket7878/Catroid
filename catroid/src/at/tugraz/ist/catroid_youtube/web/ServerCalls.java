 ...
 */
package at.tugraz.ist.catroid_youtube.web;
...
public class ServerCalls {
	...
	private static final String VIDEO_NAME_TAG = "videoTitle";
	private static final String VIDEO_DESCRIPTION_TAG = "videoDescription";
	...
	public String uploadVideo(String projectName, String videoName, String videoDescription, String zipFileString,
			String userEmail, String language, String token) throws WebconnectionException {
		if (emailForUiTests != null) {
			userEmail = emailForUiTests;
		}
		try {
			...
			HashMap<String, String> postValues = new HashMap<String, String>();
			postValues.put(PROJECT_NAME_TAG, projectName);
			postValues.put(VIDEO_NAME_TAG, videoName);
			postValues.put(VIDEO_DESCRIPTION_TAG, videoDescription);
			postValues.put(USER_EMAIL, userEmail);
			postValues.put(PROJECT_CHECKSUM_TAG, md5Checksum.toLowerCase());
			postValues.put(Consts.TOKEN, token);
