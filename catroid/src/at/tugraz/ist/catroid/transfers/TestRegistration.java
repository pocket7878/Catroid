...
public class TestRegistration extends AsyncTask<Void, Void, Boolean> {
	...
	public TestRegistration(Activity activity, String username, String password, Dialog dialogToRemoveOnSuccess) {
	...
	protected Boolean doInBackground(Void... arg0) {
		...
		if (username.equals("simge") || password.equals("password")) {
			userRegistered = true;
		}
