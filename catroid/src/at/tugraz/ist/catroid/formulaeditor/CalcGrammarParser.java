...
public class CalcGrammarParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "CONSTANT", "DECINT", "DIGIT", "GT", "ID", "LAND", "LETTER", "LT", "MINUS", "MULOP", "NOT", "NUMBER", "OR", "PLUS", "RELOP", "SENSOR", "UPID", "UPPERCASE", "WS", "'('", "')'", "','"
    };
    ...
    public String[] getTokenNames() { return CalcGrammarParser.tokenNames; }
            ...
            switch (alt5) {
                case 1 :
                    ...
                    CONSTANT7=(Token)match(input,CONSTANT,FOLLOW_CONSTANT_in_variableOrFunction255); 
                                    ...
                                    variableOrFunctionTree = new FormulaElement(FormulaElement.ElementType.CONSTANT, CONSTANT7.getText(), null, null, null);
                ...
                case 2 :
                    ...
                    match(input,24,FOLLOW_24_in_variableOrFunction440); 
                                    ...
                                    variableOrFunctionTree = new FormulaElement(FormulaElement.ElementType.FUNCTION, ID8.getText(), null, leftChild, rightChild);
                ...
                case 3 :
                    ...
                    SENSOR9=(Token)match(input,SENSOR,FOLLOW_SENSOR_in_variableOrFunction467); 
                                    ...
                                    variableOrFunctionTree = new FormulaElement(FormulaElement.ElementType.SENSOR, SENSOR9.getText(), null, null, null);
                ...
                case 4 :
                    ...
                    UPID10=(Token)match(input,UPID,FOLLOW_UPID_in_variableOrFunction493); 
                                    ...
                                    variableOrFunctionTree = new FormulaElement(FormulaElement.ElementType.VARIABLE, UPID10.getText(), null, null, null);
    ...
    public static final BitSet FOLLOW_term_list_in_variableOrFunction321 = new BitSet(new long[]{0x0000000003000000L});
    public static final BitSet FOLLOW_25_in_variableOrFunction367 = new BitSet(new long[]{0x0000000000989110L});
    public static final BitSet FOLLOW_term_list_in_variableOrFunction371 = new BitSet(new long[]{0x0000000001000000L});
