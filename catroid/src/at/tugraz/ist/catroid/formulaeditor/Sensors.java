...
public enum Sensors {
	X_ACCELERATION_("X_ACCELERATION_"), Y_ACCELERATION_("Y_ACCELERATION_"), Z_ACCELERATION_("Z_ACCELERATION_"), AZIMUTH_ORIENTATION_(
			...
			"COSTUME_X_"), COSTUME_Y_("COSTUME_Y_"), COSTUME_GHOSTEFFECT_("COSTUME_GHOSTEFFECT_"), SPRITE_BRITHNESS_(
			"SPRITE_BRITHNESS_"), SPRITE_SIZE_("SPRITE_SIZE_"), SPRITE_ROTATION_("SPRITE_ROTATION_"), SPRITE_LAYER_(
			"SPRITE_LAYER_");
