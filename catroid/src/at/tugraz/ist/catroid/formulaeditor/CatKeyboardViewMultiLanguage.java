...
import at.tugraz.ist.catroid.ui.dialogs.ChooseCostumeVariableFragmentMultiLanguage;

import com.actionbarsherlock.app.SherlockFragmentActivity;

public class CatKeyboardViewMultiLanguage extends KeyboardView implements KeyboardView.OnKeyboardActionListener {

	static final int NUMBER_KEYBOARD = 1;
	static final int FUNCTION_KEYBOARD = 0;
	static final int SENSOR_KEYBOARD = 2;

	private FormulaEditorEditTextMultiLanguage editText;

	private CatKeyboard symbolsNumbers;
	private CatKeyboard symbolsFunctions;
	private CatKeyboard symbolsSensors;
	private Context context;
	private ChooseCostumeVariableFragmentMultiLanguage chooseSpriteVariablesFragment;
	private View swipeBar;

	public CatKeyboardViewMultiLanguage(Context context, AttributeSet attrs) {
		...
		if (((SherlockFragmentActivity) context).getSupportFragmentManager().findFragmentByTag(
			...
			this.chooseSpriteVariablesFragment = ChooseCostumeVariableFragmentMultiLanguage
					.newInstance(android.R.string.dialog_alert_title);
			this.chooseSpriteVariablesFragment.setCatKeyboardView(this);
		} else {
			this.chooseSpriteVariablesFragment = (ChooseCostumeVariableFragmentMultiLanguage) ((SherlockFragmentActivity) context)
	...
	public void init(FormulaEditorEditTextMultiLanguage editText, View swipeBar) {
