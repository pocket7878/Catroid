// $ANTLR 3.4 src/CalcGrammar.g 2012-08-22 17:44:33
...
public class CalcGrammarLexer extends Lexer {
    ...
    public String getGrammarFileName() { return "src/CalcGrammar.g"; }
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:290:5: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
            // src/CalcGrammar.g:290:7: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
            {
    ...
    public final void mLT() throws RecognitionException {
        try {
            // src/CalcGrammar.g:300:13: ( '<' )
            // src/CalcGrammar.g:300:15: '<'
            {
            match('<'); 
    ...
    public final void mGT() throws RecognitionException {
        try {
            // src/CalcGrammar.g:301:13: ( '>' )
            // src/CalcGrammar.g:301:15: '>'
            {
            match('>'); 
    ...
    public final void mRELOP() throws RecognitionException {
        try {
            int _type = RELOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:302:10: ( ( LT | ( LT '=' ) | GT | ( GT '=' ) | ( '=' ) ) )
            // src/CalcGrammar.g:302:12: ( LT | ( LT '=' ) | GT | ( GT '=' ) | ( '=' ) )
            {
            // src/CalcGrammar.g:302:12: ( LT | ( LT '=' ) | GT | ( GT '=' ) | ( '=' ) )
            int alt2=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // src/CalcGrammar.g:302:16: ( LT '=' )
                    {
                    // src/CalcGrammar.g:302:16: ( LT '=' )
                    // src/CalcGrammar.g:302:17: LT '='
                    {
                    mLT(); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // src/CalcGrammar.g:302:27: ( GT '=' )
                    {
                    // src/CalcGrammar.g:302:27: ( GT '=' )
                    // src/CalcGrammar.g:302:28: GT '='
                    {
                    mGT(); 
                    ...
                    break;
                case 5 :
                    // src/CalcGrammar.g:302:35: ( '=' )
                    {
                    // src/CalcGrammar.g:302:35: ( '=' )
                    // src/CalcGrammar.g:302:36: '='
                    {
                    match('='); 
    ...
    public final void mMINUS() throws RecognitionException {
        try {
            int _type = MINUS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:305:10: ( '-' )
            // src/CalcGrammar.g:305:12: '-'
            {
            match('-'); 
    ...
    public final void mOR() throws RecognitionException {
        try {
            int _type = OR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:306:10: ( '|' )
            // src/CalcGrammar.g:306:12: '|'
            {
            match('|'); 
    ...
    public final void mNOT() throws RecognitionException {
        try {
            int _type = NOT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:307:10: ( '!' )
            // src/CalcGrammar.g:307:12: '!'
            {
            match('!'); 
    ...
    public final void mLAND() throws RecognitionException {
        try {
            int _type = LAND;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:308:10: ( '&' )
            // src/CalcGrammar.g:308:12: '&'
            {
            match('&'); 
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            int _type = NUMBER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:311:11: ( DECINT )
            // src/CalcGrammar.g:311:13: DECINT
            {
            mDECINT(); 
    ...
    public final void mDECINT() throws RecognitionException {
        try {
            // src/CalcGrammar.g:312:17: ( ( DIGIT )+ ( '.' ( DIGIT )+ )? )
            // src/CalcGrammar.g:312:19: ( DIGIT )+ ( '.' ( DIGIT )+ )?
            {
            // src/CalcGrammar.g:312:19: ( DIGIT )+
            int cnt3=0;
            loop3:
            do {
                int alt3=2;
            ...
            // src/CalcGrammar.g:312:28: ( '.' ( DIGIT )+ )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // src/CalcGrammar.g:312:29: '.' ( DIGIT )+
                    {
                    match('.'); 

                    // src/CalcGrammar.g:312:33: ( DIGIT )+
                    int cnt4=0;
                    loop4:
                    do {
                        int alt4=2;
    ...
    public final void mID() throws RecognitionException {
        try {
            int _type = ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:316:11: ( LETTER ( LETTER )* )
            // src/CalcGrammar.g:316:15: LETTER ( LETTER )*
            {
            mLETTER(); 


            // src/CalcGrammar.g:316:21: ( LETTER )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mSENSOR() throws RecognitionException {
        try {
            int _type = SENSOR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/CalcGrammar.g:317:11: ( 'X_ACCELERATION_' | 'Y_ACCELERATION_' | 'Z_ACCELERATION_' | 'AZIMUTH_ORIENTATION_' | 'PITCH_ORIENTATION_' | 'ROLL_ORIENTATION_' | 'COSTUME_X_' | 'COSTUME_Y_' | 'COSTUME_GHOSTEFFECT_' | 'COSTUME_BRIGHTNESS_' | 'COSTUME_SIZE_' | 'COSTUME_ROTATION_' | 'COSTUME_LAYER_' )
            int alt7=13;
            switch ( input.LA(1) ) {
            case 'X':
                {
            ...
            switch (alt7) {
                case 1 :
                    // src/CalcGrammar.g:317:15: 'X_ACCELERATION_'
                    {
                    ...
                    break;
                case 2 :
                    // src/CalcGrammar.g:317:33: 'Y_ACCELERATION_'
                    {
                    ...
                    break;
                case 3 :
                    // src/CalcGrammar.g:317:51: 'Z_ACCELERATION_'
                    {
                    ...
                    break;
                case 4 :
                    // src/CalcGrammar.g:317:69: 'AZIMUTH_ORIENTATION_'
                    {
                    ...
                    break;
                case 5 :
                    // src/CalcGrammar.g:317:92: 'PITCH_ORIENTATION_'
                    {
                    ...
                    break;
                case 6 :
                    // src/CalcGrammar.g:317:113: 'ROLL_ORIENTATION_'
                    {
                ...
                case 9 :
                    ...
                    break;
                case 10 :
                    // src/CalcGrammar.g:317:182: 'COSTUME_BRIGHTNESS_'
                    {
                    match("COSTUME_BRIGHTNESS_"); 
                    ...
                    break;
                case 11 :
                    // src/CalcGrammar.g:317:204: 'COSTUME_SIZE_'
                    {
                    match("COSTUME_SIZE_"); 
                    ...
                    break;
                case 12 :
                    // src/CalcGrammar.g:317:220: 'COSTUME_ROTATION_'
                    {
                    match("COSTUME_ROTATION_"); 
                    ...
                    break;
                case 13 :
                    // src/CalcGrammar.g:318:5: 'COSTUME_LAYER_'
                    {
                    match("COSTUME_LAYER_"); 
