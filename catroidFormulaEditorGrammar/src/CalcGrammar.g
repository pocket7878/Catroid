...
/*IDENTIFIER*/
ID        :   LETTER(LETTER)*;
SENSOR    :   'X_ACCELERATION_'|'Y_ACCELERATION_'|'Z_ACCELERATION_'|'AZIMUTH_ORIENTATION_'|'PITCH_ORIENTATION_'|'ROLL_ORIENTATION_'|'COSTUME_X_'|'COSTUME_Y_'|'COSTUME_GHOSTEFFECT_'|'SPRITE_BRITHNESS_'|'SPRITE_SIZE_'|'SPRITE_ROTATION_'|
				'SPRITE_LAYER_';
